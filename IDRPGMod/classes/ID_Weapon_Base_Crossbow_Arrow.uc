class ID_Weapon_Base_Crossbow_Arrow extends Projectile;
...
simulated function ProcessTouch (Actor Other, vector HitLocation)
{
	...
	if ( Other == none || Other == Instigator || Other.Base == Instigator || !Other.bBlockHitPointTraces || Other==IgnoreImpactPawn ||
		(IgnoreImpactPawn != none && Other.Base == IgnoreImpactPawn) || MaxPenetrations == 0 )
		return;
...
defaultproperties
{
     DamageTypeHeadShot=Class'IDRPGMod.ID_Weapon_Base_Crossbow_DamageType_HeadShot'
     ...
     MyDamageType=Class'IDRPGMod.ID_Weapon_Base_Crossbow_DamageType'
