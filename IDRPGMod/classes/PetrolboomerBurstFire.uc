//
//=============================================================================
class PetrolboomerBurstFire extends ID_Weapon_Base_Crossbow_Fire ;
...
static function PreloadAssets(LevelInfo LevelInfo, optional KFShotgunFire Spawned)
{
	...
	if ( PetrolboomerBurstFire(Spawned) != none )
	{
		PetrolboomerBurstFire(Spawned).FireEndSound = default.FireEndSound;
		PetrolboomerBurstFire(Spawned).AmbientFireSound = default.AmbientFireSound;
	}
}
...
function DoFireEffect()
{
	...
	local PetrolboomerTendril FiredRockets[4];
	...
	for ( p=0; p<SpawnCount; p++ )
	{
		...
		FiredRockets[p] = PetrolboomerTendril(SpawnProjectile(FireLocation, Aim));
	}
}
...
defaultproperties
{
     ...
     FireRate=0.070000
     AmmoClass=Class'IDRPGMod.PetrolboomerAmmo'
     ShakeRotMag=(X=0.000000,Y=0.000000,Z=0.000000)
     ShakeRotRate=(X=0.000000,Y=0.000000,Z=0.000000)
     ShakeOffsetMag=(X=0.000000,Y=0.000000,Z=0.000000)
     ProjectileClass=Class'IDRPGMod.PetrolboomerTendril'
