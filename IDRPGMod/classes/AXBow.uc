class AXBow extends ID_RPG_Base_Weapon
	abstract;
...
static function PreloadAssets(Inventory Inv, optional bool bSkipRefCount)
{
	...
	if ( AXBow(Inv) != none )
	{
		AXBow(Inv).ZoomMat = default.ZoomMat;
		AXBow(Inv).ScriptedTextureFallback = default.ScriptedTextureFallback;
	}
}
...
defaultproperties
{
     ...
     HudImage=Texture'DZResPack.Trader_AXBow'
     SelectedHudImage=Texture'DZResPack.Trader_AXBow'
     Weight=9.000000
     bHasAimingMode=True
     IdleAimAnim="Idle"
     StandardDisplayFOV=65.000000
     TraderInfoTexture=Texture'DZResPack.Trader_AXBow'
     bIsTier2Weapon=True
     SelectSoundRef="KF_XbowSnd.Xbow_Select"
     PlayerIronSightFOV=32.000000
     ZoomedDisplayFOV=60.000000
     FireModeClass(0)=Class'IDRPGMod.AXBowFire'
     ...
     InventoryGroup=4
     GroupOffset=1
     PickupClass=Class'IDRPGMod.AXBowPickup'
     PlayerViewOffset=(X=15.000000,Y=16.000000,Z=-12.000000)
     BobDamping=6.000000
     AttachmentClass=Class'IDRPGMod.AXBowAttachment'
     IconCoords=(X1=253,Y1=146,X2=333,Y2=181)
     ItemName="AutoXBow"
     LightType=LT_None
     LightBrightness=0.000000
     LightRadius=0.000000
     Mesh=SkeletalMesh'DZResPack.AXBowMesh'
     Skins(0)=Combiner'DZResPack.AXBowSkin1_cmb'
     Skins(2)=Combiner'KF_Weapons_Trip_T.Rifles.CBLens_cmb'
     Skins(3)=Combiner'KF_Soldier6_Trip_T.Uniforms.Steampunk_Firebug_cmb'
}
