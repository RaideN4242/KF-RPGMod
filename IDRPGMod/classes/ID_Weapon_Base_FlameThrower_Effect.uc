...
class ID_Weapon_Base_FlameThrower_Effect extends FlameThrowerFlameB;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter
         ...
         StartSizeRange=(X=(Min=1.000000,Max=5.000000),Y=(Min=0.000000,Max=0.000000),Z=(Min=0.000000,Max=0.000000))
         ...
         LifetimeRange=(Min=0.250000,Max=0.450000)
     ...
     End Object
     Emitters(0)=SpriteEmitter'IDRPGMod.ID_Weapon_Base_FlameThrower_Effect.SpriteEmitter'
