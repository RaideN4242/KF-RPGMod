class ButterFlySAAttachment extends KFMeleeAttachment ;
...
defaultproperties
{
     ...
     Mesh=SkeletalMesh'DZResPack.KnifeFlySA_3rdModel'
     Skins(0)=Texture'DZResPack.ButterKnife_Tex.butterfly_galaxy'
}
