class V94LLI extends ID_RPG_Base_Weapon
	abstract;
		...
		Instigator.IsHumanControlled() )
	{
		if( KFScopeDetail == KF_ModelScope )
		{
			...
			if( ScriptedScopeCombiner == none )
			{
				...
				ScriptedScopeCombiner.Material1 = Texture'DZResPack.V94LLI_scope';
			...
			if( ScriptedScopeStatic == none )
			{
				...
				ScriptedScopeStatic.Material1 = Texture'DZResPack.V94LLI_scope_dot';
...
simulated function bool StartFire(int Mode)
{
	...
	{
		ForceZoomOutTime = Level.TimeSeconds + 0.1;
		return true;
	}
...
{
	SetBoneScale (0, 1.0, 'Bullet_LLI');
	SetBoneScale (1, 1.0, 'Bullet_LLI1');
}
...
simulated function Notify_HideBullets()
{
	if (MagAmmoRemaining == 0)
	{
		SetBoneScale (1, 0.0, 'Bullet_LLI1');
		SetBoneScale (0, 0.0, 'Bullet_LLI');
	}
	else if (MagAmmoRemaining == 1)
	{
		SetBoneScale (1, 1.0, 'Bullet_LLI1');
...
defaultproperties
{
     ZoomMat=FinalBlend'DZResPack.V94LLI_T.V94LLI_Scope_FB'
     lenseMaterialID=2
     scopePortalFOVHigh=9.000000
     scopePortalFOV=9.000000
     ScriptedTextureFallback=Texture'DZResPack.V94LLI_T.AlphaLens'
     ReloadShortAnim="Reload_LLIePLLIeHb"
     ReloadShortRate=5.000000
     bHasScope=True
     ZoomedDisplayFOVHigh=27.000000
     MagCapacity=5
     ReloadRate=6.000000
     ReloadAnim="Reload"
     ReloadAnimRate=1.000000
     FlashBoneName="tip_LLI"
     WeaponReloadAnim="Reload_AK47"
     HudImage=Texture'DZResPack.V94LLI_T.V94LLI_Unselected'
     SelectedHudImage=Texture'DZResPack.V94LLI_T.V94LLI_selected'
     Weight=14.000000
     bHasAimingMode=True
     IdleAimAnim="Idle_Iron"
     QuickPutDownTime=0.600000
     QuickBringUpTime=0.850000
     StandardDisplayFOV=65.000000
     bModeZeroCanDryFire=True
     SleeveNum=3
     TraderInfoTexture=Texture'DZResPack.V94LLI_T.V94LLI_Trader'
     PlayerIronSightFOV=17.000000
     ZoomedDisplayFOV=27.000000
     FireModeClass(0)=Class'IDRPGMod.V94LLIFire'
     FireModeClass(1)=Class'KFMod.NoFire'
     PutDownAnim="PutDown"
     SelectAnimRate=1.200000
     PutDownAnimRate=1.400000
     PutDownTime=0.700000
     BringUpTime=0.850000
     SelectSound=Sound'DZResPack.V94LLI_SND.V94LLI_select'
     ...
     InventoryGroup=4
     GroupOffset=3
     PickupClass=Class'IDRPGMod.V94LLIPickup'
     PlayerViewOffset=(X=4.000000,Y=30.000000,Z=-14.000000)
     BobDamping=6.000000
     AttachmentClass=Class'IDRPGMod.V94LLIAttachment'
     IconCoords=(X1=253,Y1=146,X2=333,Y2=181)
     ItemName="V-94 Volga"
     Mesh=SkeletalMesh'DZResPack.V94LLIDT_mesh'
     Skins(0)=Shader'DZResPack.V94LLI_T.V94LLI_tex_1_shdr'
     Skins(1)=Combiner'KF_Weapons5_Trip_T.Weapons.M99_cmb'
     Skins(2)=Texture'DZResPack.V94LLI_T.AlphaLens'
     Skins(3)=Texture'KF_Weapons3_Trip_T.hands.Priest_Hands_1st_P'
}
