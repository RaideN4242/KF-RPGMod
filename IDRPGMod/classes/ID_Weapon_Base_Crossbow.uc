class ID_Weapon_Base_Crossbow extends ID_RPG_Base_Weapon
	abstract;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'IDRPGMod.ID_Weapon_Base_Crossbow_Fire'
     ...
     InventoryGroup=4
     GroupOffset=3
     PickupClass=Class'IDRPGMod.ID_Weapon_Base_Crossbow_Pickup'
