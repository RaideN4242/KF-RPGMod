...
//=============================================================================
class ID_Weapon_Base_LilithKiss extends ID_RPG_Base_weapon_Shotgun;
...
defaultproperties
{
     ...
     HudImage=Texture'DZResPack.pic_unsel'
     SelectedHudImage=Texture'DZResPack.pic_sel'
     Weight=13.000000
     bHasAimingMode=True
     ...
     SleeveNum=0
     TraderInfoTexture=Texture'DZResPack.pic_trader'
     ZoomInRotation=(Pitch=0,Roll=0)
     ZoomedDisplayFOV=65.000000
     FireModeClass(0)=Class'IDRPGMod.ID_Weapon_Base_LilithKiss_Fire'
     FireModeClass(1)=Class'KFMod.NoFire'
     PutDownAnim="PutDown"
     SelectSound=Sound'DZResPack.lilith_draw'
     AIRating=0.440000
     ...
     InventoryGroup=4
     GroupOffset=2
     PickupClass=Class'IDRPGMod.ID_Weapon_Base_LilithKiss_Pickup'
     PlayerViewOffset=(X=20.000000,Z=-7.000000)
     BobDamping=7.000000
     AttachmentClass=Class'IDRPGMod.ID_Weapon_Base_LilithKiss_Attachment'
     IconCoords=(X1=229,Y1=258,X2=296,Y2=307)
     ItemName="Lilith's Kisses"
     Mesh=SkeletalMesh'DZResPack.lilith_kiss'
     DrawScale=0.900000
     Skins(1)=Combiner'DZResPack.LilithK_cmb'
     Skins(3)=Combiner'DZResPack.LilithK_flip_cmb'
