//=============================================================================
// Lilith's Kiss Firing Animation:
// Happy Valentine's Day!
//=============================================================================
class ID_Weapon_Base_LilithKiss_Fire extends ID_RPG_Base_Weapon_Shotgun_Fire;
...
simulated function InitEffects()
{
	...
	if ( (FlashEmitterClass != None) && ((Flash2Emitter == None) || Flash2Emitter.bDeleteMe) )
	{
		...
		Weapon.AttachToBone(Flash2Emitter, ID_Weapon_Base_LilithKiss(Weapon).default.altFlashBoneName);
	}
...
event ModeDoFire()
{
	...
	ID_Weapon_Base_Lilithkiss(Weapon).altFlashBoneName = ID_Weapon_Base_Lilithkiss(Weapon).FlashBoneName;
	ID_Weapon_Base_Lilithkiss(Weapon).FlashBoneName = bn;
...
defaultproperties
{
     ...
     StereoFireSound=Sound'DZResPack.lilith_fire'
     FireSoundRef="DZResPack.lilith_fire_m"
     StereoFireSoundRef="DZResPack.lilith_fire"
     ProjPerFire=5
     ...
     FireAnim="FireRight"
     FireSound=Sound'DZResPack.lilith_fire_m'
     NoAmmoSound=Sound'KF_9MMSnd.9mm_DryFire'
     FireRate=0.100000
     AmmoClass=Class'IDRPGMod.ID_Weapon_Base_LilithKiss_Ammo'
     ...
     ProjectileClass=Class'IDRPGMod.ID_Weapon_Base_LilithKiss_Bullet'
