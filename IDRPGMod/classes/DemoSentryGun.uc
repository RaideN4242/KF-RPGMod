...
defaultproperties
{
     SentryClass=Class'IDRPGMod.DemoSentry'
     MagCapacity=1
     HudImage=Texture'DZResPack.I_DemoSentry'
     SelectedHudImage=Texture'DZResPack.I_DemoSentry'
     Weight=1.000000
     bModeZeroCanDryFire=True
     TraderInfoTexture=Texture'DZResPack.I_DemoSentry'
     ...
     InventoryGroup=5
     GroupOffset=6
     PickupClass=Class'IDRPGMod.DemoSentryGunPickup'
     PlayerViewOffset=(X=25.000000,Z=-25.000000)
     BobDamping=6.000000
     AttachmentClass=Class'IDRPGMod.DemoSentryGunAttachment'
