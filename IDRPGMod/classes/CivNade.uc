class CivNade extends ID_RPG_Base_Weapon;
...
{
     MagCapacity=1
     HudImage=Texture'DZResPack.CivNadeTrader'
     SelectedHudImage=Texture'DZResPack.CivNadeTrader'
     Weight=1.000000
     StandardDisplayFOV=65.000000
     bModeZeroCanDryFire=True
     TraderInfoTexture=Texture'DZResPack.CivNadeTrader'
     bIsTier2Weapon=True
     MeshRef="DZResPack.CivNadeMesh"
     SkinRefs(0)="DZResPack.FlashbangSkin"
     SelectSoundRef="KF_AA12Snd.AA12_Select"
     HudImageRef="DZResPack.CivNadeTrader"
     SelectedHudImageRef="DZResPack.CivNadeTrader"
     FireModeClass(0)=Class'IDRPGMod.CivNadeFire'
     ...
     InventoryGroup=7
     GroupOffset=11
     PickupClass=Class'IDRPGMod.CivNadePickup'
     BobDamping=6.000000
     AttachmentClass=Class'IDRPGMod.CivNadeAttachment'
     IconCoords=(X1=245,Y1=39,X2=329,Y2=79)
     ItemName="Stun Grenade"
     Mesh=SkeletalMesh'DZResPack.CivNadeMesh'
     Skins(0)=Texture'DZResPack.FlashbangSkin'
