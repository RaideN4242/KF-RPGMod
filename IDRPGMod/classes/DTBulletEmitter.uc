class DTBulletEmitter extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'IDRPGMod.DTBulletEmitter.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         DrawStyle=PTDS_AlphaBlend
         Texture=Texture'DZResPack.Exp_02'
         TextureUSubdivisions=8
         TextureVSubdivisions=8
         LifetimeRange=(Min=0.200000,Max=0.200000)
         StartVelocityRange=(Z=(Min=10.000000,Max=10.000000))
     End Object
     Emitters(1)=SpriteEmitter'IDRPGMod.DTBulletEmitter.SpriteEmitter1'
