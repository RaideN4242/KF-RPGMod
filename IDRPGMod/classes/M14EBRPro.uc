class M14EBRPro extends ID_RPG_Base_Weapon;
...
simulated function UpdateMagCapacity(PlayerReplicationInfo PRI)
{
	...
	{
		MagCapacity += 2*default.MagCapacity * class'ID_Skill_IncreasedMagazine'.static.GetMagIncreaseMulti(ID_RPG_Base_HumanPawn(Instigator), self); 
	}
}
...
defaultproperties
{
     ...
     HudImage=Texture'DZResPack.Weapon.m14_unselect'
     SelectedHudImage=Texture'DZResPack.Weapon.m14_select'
     Weight=20.000000
     bHasAimingMode=True
     ...
     FireModeClass(0)=Class'IDRPGMod.M14EBRProFire'
     FireModeClass(1)=Class'IDRPGMod.M14EBRProAltFire'
     PutDownAnim="PutDown"
     SelectSound=Sound'KF_M14EBRSnd.M14EBR_Select'
     ...
     InventoryGroup=2
     GroupOffset=5
     PickupClass=Class'IDRPGMod.M14EBRProPickup'
     PlayerViewOffset=(X=25.000000,Y=17.000000,Z=-8.000000)
     BobDamping=6.000000
     AttachmentClass=Class'IDRPGMod.M14EBRProAttachment'
     IconCoords=(X1=245,Y1=39,X2=329,Y2=79)
     ItemName="M14 EBR Pro"
     Mesh=SkeletalMesh'KF_Weapons2_Trip.M14_EBR_Trip'
     Skins(0)=Texture'DZResPack.Weapon_M14.M14_D'
