class AUG_A1AR extends ID_RPG_Base_Weapon;
		...
		Instigator.IsHumanControlled() )
	{
		if( KFScopeDetail == KF_ModelScope )
		{
			...
			if( ScriptedScopeCombiner == none )
			{
				...
				ScriptedScopeCombiner.Material1 = Texture'DZResPack.AUG_A1_T.AUG-A1_scope';
...
defaultproperties
{
     ZoomMat=FinalBlend'DZResPack.AUG_A1_T.AUG-A1_scope_FB'
     lenseMaterialID=4
     scopePortalFOVHigh=17.000000
     scopePortalFOV=17.000000
     ScriptedTextureFallback=Texture'DZResPack.AUG_A1_T.alpha_lens_64x64'
     bHasScope=True
     ...
     HudImage=Texture'DZResPack.AUG_A1_T.AUG_A1_Unselected'
     SelectedHudImage=Texture'DZResPack.AUG_A1_T.AUG_A1_Selected'
     Weight=6.000000
     bHasAimingMode=True
     ...
     SleeveNum=0
     TraderInfoTexture=Texture'DZResPack.AUG_A1_T.trader_AUG_A1'
     PlayerIronSightFOV=32.000000
     ZoomedDisplayFOV=70.000000
     FireModeClass(0)=Class'IDRPGMod.AUG_A1ARFire'
     FireModeClass(1)=Class'KFMod.NoFire'
     PutDownAnim="PutDown"
     SelectSound=Sound'DZResPack.AUG_A1_SND.aug_draw'
     ...
     InventoryGroup=4
     GroupOffset=3
     PickupClass=Class'IDRPGMod.AUG_A1ARPickup'
     PlayerViewOffset=(X=15.000000,Y=12.000000,Z=-2.000000)
     BobDamping=5.000000
     AttachmentClass=Class'IDRPGMod.AUG_A1ARAttachment'
     IconCoords=(X1=253,Y1=146,X2=333,Y2=181)
     ItemName="Steyr AUG A1"
     Mesh=SkeletalMesh'DZResPack.AUG_A1_mesh'
     Skins(0)=Texture'KF_Weapons3_Trip_T.hands.Priest_Hands_1st_P'
     Skins(1)=Combiner'DZResPack.AUG_A1_T.AUG_A1_tex_1_cmb'
     Skins(2)=Combiner'DZResPack.AUG_A1_T.AUG_A1_tex_2_cmb'
     Skins(3)=Combiner'DZResPack.AUG_A1_T.AUG_A1_tex_3_cmb'
     Skins(4)=Texture'DZResPack.AUG_A1_T.alpha_lens_64x64'
}
