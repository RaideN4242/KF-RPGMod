	...
	vector HitLocation, out vector Momentum, class<DamageType> DamageType )
{
	...
	if ( KFDamType != none && ZedVictim != none && ZombieBossBase(ZedVictim)==none && ZedVictim.Controller != none  && ZedVictim.Health > 0 ) 
	{
...
defaultproperties
{
     ...
     ShatteredIce=Class'IDRPGMod.IceChunkEmitter'
     bDosh=True
}
