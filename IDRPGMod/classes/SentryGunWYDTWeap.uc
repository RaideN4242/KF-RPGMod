...
// PTurret.
//=============================================================================
class SentryGunWYDTWeap extends ID_Weapon_Base_Turret_Base
	Config(KFSentryGunWYDT);

//var SentryGunWYDT CurrentSentry;
...
var class<SentryGunWYDT> SentryClass;
...
event ServerStartFire(byte Mode)
{
	...
	if( CurrentSentry==None )
	{
		...
		{
			CurrentSentry = Spawn(Class'SentryGunWYDT',,,Spot,R);
			if( CurrentSentry!=None )
			{
				if( PlayerController(Instigator.Controller)!=None )
					PlayerController(Instigator.Controller).ReceiveLocalizedMessage(Class'SentryGunWYDTMessage',1);
		...
		if( PlayerController(Instigator.Controller)!=None )
			PlayerController(Instigator.Controller).ReceiveLocalizedMessage(Class'SentryGunWYDTMessage',0);
	}
}
*/
...
defaultproperties
{
     SentryClass=Class'IDRPGMod.SentryGunWYDT'
     SentryStationaryClass=Class'IDRPGMod.SentryGunWYDT'
     MagCapacity=1
     HudImage=Texture'DZResPack.SentryGunDTWY_T.SentryGunWY_Unselected'
     SelectedHudImage=Texture'DZResPack.SentryGunDTWY_T.SentryGunWY_Selected'
     Weight=355.000000
     bModeZeroCanDryFire=True
     TraderInfoTexture=Texture'DZResPack.SentryGunDTWY_T.SentryGunWY_Trader'
     ...
     InventoryGroup=5
     GroupOffset=6
     PickupClass=Class'IDRPGMod.SentryGunWYDTPickup'
     PlayerViewOffset=(X=25.000000,Z=-25.000000)
     BobDamping=6.000000
     AttachmentClass=Class'IDRPGMod.SentryGunWYDTAttachment'
     ...
     AmbientGlow=35
     MessageClass=Class'IDRPGMod.SentryGunWYDTMessage'
}
