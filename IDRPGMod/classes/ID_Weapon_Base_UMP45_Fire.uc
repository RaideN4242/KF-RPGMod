class ID_Weapon_Base_UMP45_Fire extends ID_RPG_Base_Weapon_Fire;
...
defaultproperties
{
     ...
     StereoFireSound=Sound'DZResPack.ump45_shot_stereo'
     bRandomPitchFireSound=False
     DamageType=Class'IDRPGMod.ID_Weapon_Base_UMP45_DamageType'
     DamageMin=35
     DamageMax=50
     ...
     FireLoopAnim="Fire"
     TweenTime=0.025000
     FireSound=Sound'DZResPack.ump45_shot_mono'
     NoAmmoSound=Sound'DZResPack.ump45_empty'
     FireForce="AssaultRifleFire"
     FireRate=0.109000
     AmmoClass=Class'IDRPGMod.ID_Weapon_Base_UMP45_Ammo'
     AmmoPerFire=1
