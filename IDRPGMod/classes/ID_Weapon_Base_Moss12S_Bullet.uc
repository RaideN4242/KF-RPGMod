...
// Shotgun Bullet
//=============================================================================
class ID_Weapon_Base_Moss12S_Bullet extends Projectile;
...
simulated function ProcessTouch (Actor Other, vector HitLocation)
{
	...
	if ( Other == none || Instigator == none || Other == Instigator || Other.Base == Instigator || !Other.bBlockHitPointTraces  )
		return;
...
defaultproperties
{
     ...
     MyDamageType=Class'IDRPGMod.ID_RPG_Base_Weapon_DamageType_Shotgun'
