class MP7DAltFire extends ID_RPG_Base_Weapon_Fire;
...
simulated function InitEffects()
{
	...
	if(FlashEmitterClass!=None && (Flash2Emitter==None || Flash2Emitter.bDeleteMe))
	{
		...
		Weapon.AttachToBone(Flash2Emitter, MP7Dual(Weapon).default.altFlashBoneName);
	}
...
simulated function bool AllowFire()
{
	...
	if(KFWeapon(Weapon).AmmoAmount(1)<1)
	{
...
event ModeDoFire()
{
	...
	bn=MP7Dual(Weapon).altFlashBoneName;
	MP7Dual(Weapon).altFlashBoneName=MP7Dual(Weapon).FlashBoneName;
	MP7Dual(Weapon).FlashBoneName=bn;
...
defaultproperties
{
     ...
     ShellEject2BoneName="Shell_eject_left"
     ...
     DamageType=Class'IDRPGMod.DamTypeFreezerBase'
     DamageMin=2250
     DamageMax=2250
     ...
     FireRate=0.153800
     AmmoClass=Class'IDRPGMod.MP7DAltAmmo'
     AmmoPerFire=2
