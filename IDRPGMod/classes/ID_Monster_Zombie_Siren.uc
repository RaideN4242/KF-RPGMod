class ID_Monster_Zombie_Siren extends ID_Monster_Zombie_Siren_Base;
...
simulated function SpawnTwoShots()
{
	if (Controller != none && Controller.Target != none && 
		(ID_RPG_Base_HumanPawn(Controller.Target) != none && !ID_RPG_Base_HumanPawn(Controller.Target).CanBeAttacked()))
		return;
	DoShakeEffect();
