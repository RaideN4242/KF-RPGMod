class ID_Weapon_Base_Moss12S_Attachment extends KFWeaponAttachment;
...
defaultproperties
{
     ...
     Mesh=SkeletalMesh'WPCAlienWeap_A.Moss12_3rd'
     Skins(0)=Texture'WPCAlienWeap_T.3rd.3rd_Moss12'
}
