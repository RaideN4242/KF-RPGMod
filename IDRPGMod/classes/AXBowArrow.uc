class AXBowArrow extends Projectile;
...
Ignores HitWall;
	...
	function ProcessTouch (Actor Other, vector HitLocation)
	{
		...
		if( Pawn(Other)!=None && Pawn(Other).Inventory!=None )
		{
			...
			{
				if( AXBow(Inv)!=None && Weapon(inv).AmmoAmount(0)<Weapon(inv).MaxAmmo(0) )
				{
...
defaultproperties
{
     DamageTypeHeadShot=Class'IDRPGMod.DamTypeAXBowHeadShot'
     ...
     MyDamageType=Class'IDRPGMod.DamTypeAXBow'
