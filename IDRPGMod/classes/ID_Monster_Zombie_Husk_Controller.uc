class ID_Monster_Zombie_Husk_Controller extends KFMonsterController;
...
function bool FireWeaponAt(Actor A)
{
	...
	if( (VSize(A.Location - Pawn.Location) >= ID_Monster_Zombie_Husk(Pawn).MeleeRange + Pawn.CollisionRadius + Target.CollisionRadius) &&
		ID_Monster_Zombie_Husk(Pawn).NextFireProjectileTime - Level.TimeSeconds > 0 )
	{
		return false;
	}
