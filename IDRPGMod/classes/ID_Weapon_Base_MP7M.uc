class ID_Weapon_Base_MP7M extends ID_RPG_Base_Weapon;
...
defaultproperties
{
     ...
     HudImage=Texture'KillingFloor2HUD.WeaponSelect.MP7m_unselected'
     SelectedHudImage=Texture'KillingFloor2HUD.WeaponSelect.MP7m'
     Weight=3.000000
     bHasAimingMode=True
     ...
     FireModeClass(0)=Class'IDRPGMod.ID_Weapon_Base_MP7M_Fire'
     FireModeClass(1)=Class'IDRPGMod.ID_Weapon_Base_MP7M_AltFire'
     PutDownAnim="PutDown"
     ...
     InventoryGroup=4
     GroupOffset=8
     PickupClass=Class'IDRPGMod.ID_Weapon_Base_MP7M_Pickup'
