Class TurretLazorM extends Emitter
	Transient;

var PortalTurretM TurretOwner;
var BeamEmitter BM;

simulated function BeginPlay()
{
	TurretOwner = PortalTurretM(Owner);
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=BeamEmitter'IDRPGMod.TurretLazorM.BeamEmitter0'
