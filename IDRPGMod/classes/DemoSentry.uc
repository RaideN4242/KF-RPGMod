class DemoSentry extends Pawn;
	
#exec OBJ LOAD FILE=KF_LAWSnd.uax

var int HitDamages,SentryHealth;
...
final function SetOwningPlayer(Pawn Other, DemoSentryGun W)
{
	OwnerPawn=Other;
...
{
	if(!bBlockActors && Other.IsA('KFMonster'))
		bBlockActors=true;
...
simulated function PostRender2D(Canvas C, float ScreenLocX, float ScreenLocY)
{
	...
	S="Health: "@Health@"/"@SentryHealth;			// ShadowEvil
	C.TextSize(S,XL,YL);
...
function Timer()
{
	...
	foreach TraceActors(Class'Actor',Res,HL,HN,Location+X*8000.f,Location)
	{
		if(Res!=Self && (Res==Level || Res.bBlockActors || Res.bProjTarget || Res.bWorldGeometry) && KFPawn(Res)==None
			&& KFBulletWhipAttachment(Res)==None && DemoSentry(Res)==None && SVehicle(Res)==None)
		{
			A=Res;
			break;
		}
	...
	{
		A.TakeDamage(HitDamages,OwnerPawn,HL,X*1000.f,Class'ID_Weapon_Base_Turret_DamageType');
		/*if(OwnerPawn!=none)
		{
...
simulated function TraceFX(Actor A , vector HL, vector HN)
{
	...
	PlaySound(Sound'DZResPack.DTShoot',SLOT_Pain,2.f,,800.f);
...
{
	local DTBullet DTb;
	DTb=Spawn(class'DTBullet',OwnerPawn,, HL, Rotator(-HN));
	DTb.Damage=HitDamages;
	//log("spwn bullet");
}

function TakeDamage(int Damage, Pawn InstigatedBy, vector HitLocation, vector Momentum, class<DamageType>DamageType, optional int HitIndex)
{
	if((KFHumanPawn(instigatedBy)!=None && damageType!=class'DamTypeWelder'))
		Return;
...
simulated function HurtRadius(float DamageAmount, float DamageRadius, class<DamageType>DamageType, float Momentum, vector HitLocation)
{
	...
	foreach CollidingActors (class 'Actor', Victims, DamageRadius, HitLocation)
	{
		...
		&& ExtendedZCollision(Victims)==None && KFPawn(Victims)==None && SVehicle(Victims)==None && DemoSentry(Victims)==None)
		{
...
defaultproperties
{
     HitDamages=10
     SentryHealth=250
     FootStep(0)=Sound'DZResPack.Sentry.Sentry_sstep_01'
     FootStep(1)=Sound'DZResPack.Sentry.Sentry_sstep_02'
     FootStep(2)=Sound'DZResPack.Sentry.Sentry_sstep_03'
     FootStep(3)=Sound'DZResPack.Sentry.Sentry_sstep_04'
     VoicesList(0)=Sound'DZResPack.Sentry.Sentry_activate_01'
     VoicesList(1)=Sound'DZResPack.Sentry.Sentry_cant_reach_player_01'
     VoicesList(2)=Sound'DZResPack.Sentry.Sentry_cant_reach_player_02'
     VoicesList(3)=Sound'DZResPack.Sentry.Sentry_destroyed_01'
     VoicesList(4)=Sound'DZResPack.Sentry.Sentry_fight_enemy_02'
     VoicesList(5)=Sound'DZResPack.Sentry.Sentry_sight_enemy_01'
     VoicesList(6)=Sound'DZResPack.Sentry.Sentry_lost_target_01'
     VoicesList(7)=Sound'DZResPack.Sentry.Sentry_pain_01'
     VoicesList(8)=Sound'DZResPack.Sentry.Sentry_pain_02'
     VoicesList(9)=Sound'DZResPack.Sentry.Sentry_pain_03'
     VoicesList(10)=Sound'DZResPack.Sentry.Sentry_pain_04'
     VoicesList(11)=Sound'DZResPack.Sentry.Sentry_shutdown_01'
     VoicesList(12)=Sound'DZResPack.Sentry.Sentry_sight_friendly_01'
     VoicesList(13)=Sound'DZResPack.Sentry.Sentry_wait_for_player_01'
     VoicesList(14)=Sound'DZResPack.Sentry.Sentry_wait_for_player_02'
     VoicesList(15)=Sound'DZResPack.Sentry.Sentry_wait_for_player_03'
     FiringSounds(0)=Sound'DZResPack.Sentry.Sentry_fire_01'
     FiringSounds(1)=Sound'DZResPack.Sentry.Sentry_fire_02'
     FiringSounds(2)=Sound'DZResPack.Sentry.Sentry_fire_03'
     FiringSounds(3)=Sound'DZResPack.Sentry.Sentry_fire_04'
     FiringSounds(4)=Sound'DZResPack.Sentry.Sentry_fire_05'
     FireRateTime=0.350000
     ...
     EyeHeight=0.000000
     Health=250
     ControllerClass=Class'IDRPGMod.DemoSentryController'
     bPhysicsAnimUpdate=True
     ...
     Mass=400.000000
     RotationRate=(Pitch=8096,Roll=6072)
}
