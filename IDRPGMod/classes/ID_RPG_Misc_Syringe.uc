class ID_RPG_Misc_Syringe extends ID_RPG_Base_Weapon_Melee;
...
{
	ID_RPG_Misc_Syringe_Fire(FireMode[0]).AttemptHeal();
}
...
{
	ID_RPG_Misc_Syringe_Fire(FireMode[0]).SuccessfulHeal();
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'IDRPGMod.ID_RPG_Misc_Syringe_Fire'
     FireModeClass(1)=Class'IDRPGMod.ID_RPG_Misc_Syringe_AltFire'
     AIRating=-2.000000
     bMeleeWeapon=False
     ...
     InventoryGroup=5
     GroupOffset=2
     PickupClass=Class'IDRPGMod.ID_RPG_Misc_Syringe_Pickup'
     BobDamping=8.000000
