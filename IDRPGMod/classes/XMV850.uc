class XMV850 extends ID_RPG_Base_Weapon
	abstract
	config(user);
...
defaultproperties
{
     BarrelSpinSound=Sound'DZResPack.XMV-BarrelSpinLoop'
     BarrelStopSound=Sound'DZResPack.XMV-BarrelSpinEnd'
     BarrelStartSound=Sound'DZResPack.XMV-BarrelSpinStart'
     ...
     HudImage=Texture'DZResPack.XMV_unselected'
     SelectedHudImage=Texture'DZResPack.XMV'
     Weight=14.000000
     IdleAimAnim="Idle"
     StandardDisplayFOV=55.000000
     bModeZeroCanDryFire=True
     SleeveNum=7
     TraderInfoTexture=Texture'DZResPack.Trader_XMV850'
     PlayerIronSightFOV=65.000000
     ZoomedDisplayFOV=20.000000
     FireModeClass(0)=Class'IDRPGMod.XMV850Fire'
     FireModeClass(1)=Class'KFMod.NoFire'
     PutDownAnim="Putaway"
     SelectSound=Sound'DZResPack.XMV-Pullout'
     ...
     InventoryGroup=4
     GroupOffset=7
     PickupClass=Class'IDRPGMod.XMV850Pickup'
     PlayerViewOffset=(X=30.000000,Y=25.000000,Z=-16.000000)
     BobDamping=6.000000
     AttachmentClass=Class'IDRPGMod.XMV850Attachment'
     IconCoords=(X1=245,Y1=39,X2=329,Y2=79)
     ItemName="XMV 850"
     Mesh=SkeletalMesh'DZResPack.XMV-850Minigun'
     Skins(0)=Texture'DZResPack.XMV850_Main'
     Skins(1)=Texture'DZResPack.BallisticHand-1024'
     Skins(2)=Texture'DZResPack.XMV850_Barrels'
