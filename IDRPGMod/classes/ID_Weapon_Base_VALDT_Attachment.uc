class ID_Weapon_Base_VALDT_Attachment extends KFWeaponAttachment;
...
defaultproperties
{
     mMuzFlashClass=Class'IDRPGMod.ID_Weapon_Base_VALDT_MuzzleFlash3rd'
     ...
     Mesh=SkeletalMesh'DZResPack.ValDT3rd'
     DrawScale=0.550000
}
