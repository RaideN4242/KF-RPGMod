//
//=============================================================================
class ID_Weapon_Base_FlameThrower_Fire extends ID_Weapon_Base_Crossbow_Fire ;
...
state FireLoop
{
	function BeginState()
	{
		NextFireTime = Level.TimeSeconds - 0.5; //fire now!
...
defaultproperties
{
     ...
     ProjectileClass=Class'IDRPGMod.ID_Weapon_Base_FlameThrower_Tendril'
