class ID_Weapon_Base_MP7M_HealinglProjectile extends ROBallisticProjectile;
	...
	if( Role == ROLE_Authority )
	{
			...
			Healed.Health <  Healed.HealthMax )
		{
			...
			if ( PRI != None )
			{
				...
				if( ID_Weapon_Base_MP7M(Instigator.Weapon) != none )
				{
					ID_Weapon_Base_MP7M(Instigator.Weapon).ClientSuccessfulHeal(Healed.PlayerReplicationInfo.PlayerName);
				}
			}
		}
	}
