class ID_Weapon_Base_M14EBR extends ID_RPG_Base_Weapon
	config(user)
	abstract;
...
defaultproperties
{
     ...
     HudImage=Texture'KillingFloor2HUD.WeaponSelect.M14_unselected'
     SelectedHudImage=Texture'KillingFloor2HUD.WeaponSelect.M14'
     Weight=8.000000
     bHasAimingMode=True
     ...
     FireModeClass(0)=Class'IDRPGMod.ID_Weapon_Base_M14EBR_Fire'
     ...
     InventoryGroup=4
     GroupOffset=5
     PickupClass=Class'IDRPGMod.ID_Weapon_Base_M14EBR_Pickup'
     ...
     Skins(0)=Combiner'KF_Weapons2_Trip_T.Rifle.M14_cmb'
