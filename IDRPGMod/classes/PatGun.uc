//
// Written by MetalMedved
// http://metalmedved.com - custom skins, weapons and mutators
//
class PatGun extends ID_RPG_Base_Weapon
	abstract
	config(user);
...
defaultproperties
{
     ...
     HudImage=Texture'DZResPack.patgun_selected'
     SelectedHudImage=Texture'DZResPack.patgun_unselected'
     Weight=15.000000
     IdleAimAnim="Idle"
     StandardDisplayFOV=55.000000
     bModeZeroCanDryFire=True
     TraderInfoTexture=Texture'DZResPack.patgun_unselected'
     bIsTier2Weapon=True
     SelectSoundRef="KF_MP7Snd.MP7_Select"
     PlayerIronSightFOV=65.000000
     ZoomedDisplayFOV=45.000000
     FireModeClass(0)=Class'IDRPGMod.PatGunFire'
     FireModeClass(1)=Class'IDRPGMod.PatGunAltFire'
     PutDownAnim="PutDown"
     ...
     InventoryGroup=4
     GroupOffset=5
     PickupClass=Class'IDRPGMod.PatGunPickup'
     PlayerViewOffset=(X=40.000000,Y=40.000000,Z=16.000000)
     BobDamping=6.000000
     AttachmentClass=Class'IDRPGMod.PatGunAttachment'
     IconCoords=(X1=245,Y1=39,X2=329,Y2=79)
     ItemName="PatGun"
     Mesh=SkeletalMesh'DZResPack.PatGunMesh'
     ...
     Skins(3)=Texture'DZResPack.Handle'
