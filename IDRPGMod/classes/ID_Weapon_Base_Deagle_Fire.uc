class ID_Weapon_Base_Deagle_Fire extends ID_RPG_Base_Weapon_Fire;
...
function DoTrace(Vector Start, Rotator Dir)
{
	...
	HitDamage = DamageMax;
	While( HitCount < MaxPenetrations )
	{
		HitCount++;
		DamageActor = none;
		...
		if ( !Other.bWorldGeometry && Other!=Level )
		{
			...
			HitDamage *= 1 - PenDamageReduction;
			Start = HitLocation;
		}
...
defaultproperties
{
     ...
     StereoFireSound=SoundGroup'KF_HandcannonSnd.50AE_FireST'
     DamageType=Class'IDRPGMod.ID_Weapon_Base_Deagle_DamageType'
     DamageMin=95
     DamageMax=115
