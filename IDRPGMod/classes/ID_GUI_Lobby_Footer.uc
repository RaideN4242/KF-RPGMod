class ID_GUI_Lobby_Footer extends LobbyFooter;
...
function bool OnFooterClick(GUIComponent Sender)
{
	...
	else if(Sender == b_Ready)
	{
		...
		PC.ClientOpenMenu(string(Class'ID_GUI_InvasionLoginMenu'), false);
	return false;
}
...
defaultproperties
{
     Begin Object Class=GUIButton Name=PerksButton
         ...
         OnClick=ID_GUI_Lobby_Footer.OnFooterClick
         OnKeyEvent=Cancel.InternalOnKeyEvent
     End Object
     b_Perks=GUIButton'IDRPGMod.ID_GUI_Lobby_Footer.PerksButton'
