class ID_Monster_Zombie_Scrake extends ID_Monster_Zombie_Scrake_Base;
...
function PlayTakeHit(vector HitLocation, int Damage, class<DamageType> DamageType)
{
	...
	if( Damage>=150 || (DamageType.name=='DamTypeStunNade' && StunChance>3) || (DamageType.name=='ID_Weapon_Base_Crossbow_DamageType_HeadShot' && Damage>=200) )
...
defaultproperties
{
     ...
     ControllerClass=Class'IDRPGMod.ID_Monster_Zombie_Scrake_Controller'
}
