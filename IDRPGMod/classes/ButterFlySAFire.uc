class ButterFlySAFire extends ID_RPG_Base_Weapon_Melee_Fire;
...
defaultproperties
{
     FireAnims(0)="MidSlash1"
     FireAnims(1)="MidSlash2"
     FireAnims(2)="MidSlash2"
     FireAnims(3)="MidSlash1"
     MeleeDamage=1000
     ProxySize=0.120000
