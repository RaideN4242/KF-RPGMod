...
// AKFTurret.
//=============================================================================
class AKFTurret extends ID_Weapon_Base_Turret_Base
	Config(USCMTurret);
	
//var USCMTurret CurrentSentry;
...
var class<USCMTurret> SentryClass;
...
defaultproperties
{
     SentryClass=Class'IDRPGMod.USCMTurret'
     SentryStationaryClass=Class'IDRPGMod.USCMTurret'
     bStationaryTurret=True
     MagCapacity=1
     HudImage=Texture'DZResPack.HUD_turret_unselected'
     SelectedHudImage=Texture'DZResPack.HUD_turret_selected'
     Weight=1.000000
     bModeZeroCanDryFire=True
     SleeveNum=2
     TraderInfoTexture=Texture'DZResPack.Trader_Turret'
     ...
     InventoryGroup=5
     GroupOffset=6
     PickupClass=Class'IDRPGMod.AKFTurretPickup'
     PlayerViewOffset=(X=25.000000,Z=-25.000000)
     BobDamping=6.000000
     AttachmentClass=Class'IDRPGMod.AKFTurretAttachment'
